...
- ✔️ Good understanding of Machine Learning/Deep Learning Projects(CV, NLP, Mediacl Image Analysis, Bussiness/Finance Data Projects, Time Series Processing) architecture and creating pipeline(data processing, model building, traning, evaluation)
      packaging, restfull api integration, Web app development and deploy for predict and inferencing on paas cloud(streamlit, heroku e.t.c)/ecosystem like tensorflow serving.
