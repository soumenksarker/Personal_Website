...
profile_pic = current_dir / "assets" / "1691435429378.jpg"
...
PROJECTS = {
"🏆 Built and deployed an NLP application that reveals named entities, classifies sentiment, and does OCR base Bangla(extractive) and English(abstructive) text summarization using tesseract, spacy, textblob, genism, T5, and gpt2-large.": "https://huggingface.co/spaces/Soumen/Text-Summarization-and-NLP-tasks",
