...
PROJECTS = {
"🏆 Real-Time web scraping and insertion on database, integrated for Dashboard.": "https://github.com/soumenksarker/RealtimeScraperOpenSearchPostgresIntegration",
"🏆 Question and answer system to Analysis and Visualize, integrated with first project.":"https://huggingface.co/spaces/Soumen/QAsystemforcsvjsonxlsx",
